...
__tool_NotebookEdit_schema = {
    "name": "NotebookEdit",
    "description": "Completely replaces the contents of a specific cell in a Jupyter notebook (.ipynb) with new source. The notebook_path must be an absolute path. Use edit_mode=insert to add a new cell after the cell with the given cell_id (or at the beginning if not specified). Use edit_mode=delete to delete the cell. Defaults to replace.",
    "parameters": {
        "type": "object",
        "properties": {
        "notebook_path": {
                "type": "string",
                "description": "Parameter notebook_path"
        },
        "cell_id": {
                "type": "string",
        ...
        "new_source": {
                "type": "string",
                "description": "Parameter new_source"
        },
        "cell_type": {
                "type": "string",
                "description": "Parameter cell_type"
        },
        "edit_mode": {
                "type": "string",
                "description": "Parameter edit_mode"
        }
},
        "required": ["notebook_path", "cell_id", "new_source", "cell_type", "edit_mode"]
    }
}

def NotebookEdit(notebook_path, cell_id, new_source, cell_type, edit_mode):
...
LOCAL_TOOLS['NotebookEdit'] = NotebookEdit
